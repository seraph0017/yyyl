  ...
  <div class="page-container membership-page">
    <div class="card-box">
      <div class="page-header">
        <div>
          <h2>会员卡</h2>
          <p>统一查看会员卡总览、年卡配置与次数卡配置，兼容旧入口。</p>
        </div>
      ...
      <el-tabs v-model="activeTab" class="workspace-tabs">
        ...
        <el-tab-pane label="年卡配置" name="annual">
          <div class="toolbar">
          ...
          <el-table :data="annualCards" v-loading="cardLoading" stripe>
            ...
            <el-table-column label="适用商品" min-width="220">
              <template #default="{ row }">
                <span class="muted">{{ formatProducts(row.applicable_products) }}</span>
              </template>
            </el-table-column>
        ...
        <el-tab-pane label="次数卡配置" name="times">
          <div class="toolbar">
