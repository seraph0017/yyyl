...
- 西郊小程序构建产物已于 2026-07-09 22:02 重新生成到 `uni-app/dist/build/mp-weixin-xijiao`，并已由用户确认上传；审核/发布状态以微信小程序后台为准。大聋谷如需同步发布，先重新构建 `uni-app/dist/build/mp-weixin-dalonggu`。
